...
class GUIApp(QMainWindow):
    ...
    def perform_action(self, action):
        ...
        if action == "Hide Candidate Profile":
            self.scroll_and_process("Hide Candidate Profile", additional_image="adicional.png")
    ...
    def scroll_and_process(self, action_name, additional_image=None):
        ...
        self.process_image(f"Muniz Recruiter Helper copy/Images/{action_name.lower()}80.png")

        if additional_image:
            time.sleep(0.7)
            self.process_image(f"Muniz Recruiter Helper copy/Images/{additional_image}")

        self.process_image("Muniz Recruiter Helper copy/Images/NextCandidadeSingle.png")
        time.sleep(0.5)

        self.process_image(f"Muniz Recruiter Helper copy/Images/Down100.png")
