...
class GUIApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.setWindowTitle("Muniz Recruiter Helper NoTe")
    ...
    def perform_action(self, action):
        ...
        if action == "Hide Candidate Profile":
            ...
            #self.process_image("Muniz Recruiter Helper NoTe/Images/Candidato Anterior.png") -- Old Way
            self.scroll_and_process_Next_Previous("Previous Candidate")
            #print("Candidato Anterior")

        elif action == "Next Candidate":
            #self.process_image("Muniz Recruiter Helper NoTe/Images/Candidato Seguinte.png") -- Old Way
            self.scroll_and_process_Next_Previous("Next Candidate")
            #print("Candidato Seguinte")

        elif action == "Show More Experience":
            self.process_image("Muniz Recruiter Helper NoTe/Images/Show More80.png")
    ...
    def scroll_and_process(self, action_name):
        ...
        self.process_image(f"Muniz Recruiter Helper NoTe/Images/{action_name.lower()}80.png")
        self.process_image("Muniz Recruiter Helper NoTe/Images/NextCandidadeSingle.png")
        time.sleep(0.5)
        self.process_image(f"Muniz Recruiter Helper NoTe/Images/Down100.png")
        print(f"{action_name}")
    ...
    def scroll_and_process_Next_Previous(self, action_name):
        ...
        if not self.process_image(f"Muniz Recruiter Helper NoTe/Images/{action_name.lower()}80.png"):
            previous_processed = False
            
        if previous_processed and not self.process_image(f"Muniz Recruiter Helper NoTe/Images/{action_name.lower()}90.png"):
            previous_processed = False
            
        if previous_processed and not self.process_image(f"Muniz Recruiter Helper NoTe/Images/{action_name.lower()}100.png"):
            previous_processed = False
            
        if previous_processed and not self.process_image(f"Muniz Recruiter Helper NoTe/Images/{action_name.lower()}110.png"):
            previous_processed = False
    ...
    def process_image(self, image_path):
        ...
        coordinates = pyautogui.locateOnScreen(image, confidence=0.67)
        if coordinates:
